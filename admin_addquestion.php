         ...
         <tbody>
             <?php while($row = $result->fetch_assoc()): ?>
                 <tr>
                     ...
                     <td><?php echo $row['name_topic'];?> </td>
                     <td><button type="submit"name="login" class="btn btn-info btn-sm"> <i class="fas fa-pencil-alt"></i>Edit</button></td>
                     <td><a href= "checkdelete_question.php?delete_id=<?php echo $row['id_topic']; ?>"  class="btn btn-danger btn-sm"> <i class="fas fa-trash"></i>Delete</td>  
                 </tr>
             <?php endwhile ?>
          </tbody>
             </table>
